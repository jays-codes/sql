...
SELECT vendor_id, COUNT(vendor_id) AS booth_count
...
SELECT customer.customer_id, customer_last_name, customer_first_name, SUM(quantity * cost_to_customer_per_qty) AS total_spent
FROM customer
...
VALUES(10, 'Jays Superfood Store', 'Fresh Focused', 'Jay ', 'Menorca ');
